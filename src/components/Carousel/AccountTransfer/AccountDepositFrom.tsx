...
import { currencyFormat, wait } from "../../../../utils/utils";
import { config } from "../../../config/Config";
import { theme } from "../../../config/Theme";
import { calcCardStyles } from "../../../../utils/accounts/accountUtils";
...
const AccountDepositFrom: React.FC<Props> = ({
  item,
  handleChange,
  depositAccount,
}) => {
  const bitPanel = useAppSelector((state) => state.client.bitPanel);
  ...
  const { backGroundColor, secondaryTextColor, mainTextColor } = calcCardStyles(
    item,
    depositAccount
  );
  ...
  return (
    <View style={styles.slide}>
      <TouchableOpacity
        onPress={() => handleChange("depositAccount", item.accountId)}
      ...
      >
        <View style={styles.cardTop}>
          <View style={{}}>
            ...
            <View>
              <Text style={{ ...styles.balance, color: secondaryTextColor }}>
        ...
        <View style={styles.cardBody}>
          <View style={styles.cardColumn1}>
            <View style={styles.accountContainer}>
              ...
              >
                <Text
                  style={{ ...styles.accountNumber, color: secondaryTextColor }}
                >
...
export default AccountDepositFrom;
