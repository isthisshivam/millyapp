...
import { GetCode, reset, ValidateCode } from "../../store/actionReducers/auth";
...
const TwoFactor = ({ navigation }) => {
  ...
  return (
    <>
      ...
      >
        <Text style={globalStyles.title}>Two Factor Authentication</Text>
              ...
              {state.codeSent ? (
                <View style={styles.verificationContainer}>
                  <View style={styles.inputContainer}>
                    <TextInput
                      ...
                      placeholder={
                        inputFocused ? "" : "Enter Verification Code"
                      }
                ...
                <>
                  <Text style={{ marginBottom: config.hp("4%") }}>
                    We will send you a code to your contact method of choice
                  </Text>
                  <TouchableOpacity
