...
import { CreateHousehold } from "../../../store/actionReducers/household";
...
import { reset } from "../../../store/actionReducers/register";

const Household = ({ handleNext, handleBack, onboardingStyles }) => {
  ...
  function Continue() {
    if (staged.length > 0) {
      ...
      let array: MemberType[] = [accountHolder];
      dispatch(CreateHousehold(array));
      return;
    }
    //handleNext();
  }
  ...
  return (
    <>
      <DraxProvider style={{ flex: 1 }}>
        <View style={styles.container}>
          ...
          >
            ...
            >
              <Text style={onboardingStyles.title}>Household</Text>
      ...
      <View style={onboardingStyles.buttonContainer}>
        <TouchableOpacity style={{ paddingVertical: 9 }} onPress={handleNext}>
          <Text style={{ fontSize: 16, color: theme.colors.fadedDark }}>
            Skip
          </Text>
        </TouchableOpacity>
        <TouchableOpacity style={onboardingStyles.button} onPress={Continue}>
